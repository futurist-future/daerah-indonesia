...
class Daerah {
   ...
   * @param {Number | String} [id] (opsional) Cari berdasarkan id daerah yang diingingkan. 
   * - Jika id 2 digit, maka akan mencari semua kabupaten/kota berdasarkan provinsinya, sedangkan
   * - jika id 4 digit, maka akan mencari data singular kabupaten/kota yang sesuai dengan id tersebut.
   * @api public
   */
  getKabupaten(id) {
    const options = id ? id.toString() : undefined;
  ...
  /**
   * Dapetin data kecamatan yang ada di Indonesia. 
   * 
   * Jika parameter dikosongkan, maka akan mencari semua kecamatan yang tersedia.
   *
   * ### Contoh:
   *
   *      const daerah = require('daerah-indonesia');
   ...
   * @param {Number | String} [id] (opsional) Cari berdasarkan id daerah yang diingingkan. 
   * - Jika id 2 digit, maka akan mencari semua kecamatan berdasarkan id provinsinya, 
   * - jika id 4 digit, maka akan mencari data kecamatan yang sesuai dengan id kabupaten/kotanya, sedangkan 
   * - jika 7 digit, maka akan menampilkan data singular kecamatan berdasarkan idnya.
   * @api public
   */
  getKecamatan(id) {
    const options = id ? id.toString() : undefined;
  ...
  /**
   * Dapetin data kelurahan yang ada di Indonesia. 
   * 
   * Jika parameter dikosongkan, maka akan mencari semua kelurahan yang tersedia.
   *
   * ### Contoh:
   *
   *      const daerah = require('daerah-indonesia');
   ...
   * @param {Number | String} [id] (opsional) Cari berdasarkan id daerah yang diingingkan. 
   * - Jika id 2 digit, maka akan mencari semua kelurahan berdasarkan id provinsinya, 
   * - jika id 4 digit, maka akan mencari data kelurahan yang sesuai dengan id kabupaten/kotanya
   * - jika 7 digit, maka akan menampilkan data kelurahan yang sesuai dengan id kabupaten/kotanya
   * - sedangkan jika 10 digit, maka akan data singular kelurahan berdasarkan idnya.
   * @api public
   */
  getKelurahan(id) {
    const options = id ? id.toString() : undefined;
